...
public class EditStudentActivity extends AppCompatActivity {
    private String pageHeading,userType,name,phone,email,search,sem,gender,dob,imageUrl,status,password,regNo,role,branch,roleData;
                ...
                if(snapshot.exists()){
                    ...
                    editButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if(!isConnected(EditStudentActivity.this)){
                                Toast.makeText(EditStudentActivity.this,"No internet connection",Toast.LENGTH_SHORT).show();
                                return;
                            }
                            ...
                            ProfileClassUser user=new ProfileClassUser(name,regNo,branch,phone,email,gender,dob,roleData,password,sem,imageUrl,status,search,true);
                            reference.setValue(user);
                            Intent intent = new Intent(EditStudentActivity.this, AddDeleteUserActivity.class);
    ...
    private boolean isConnected(EditStudentActivity activity) {

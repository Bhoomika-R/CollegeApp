package com.example.admindashboard.students;
...
public class AddStudentActivity extends AppCompatActivity {
    private String pageHeading,userType,name,phone,regNo,search;
    ...
    private EditText etName,etPhone,etRegNo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etRegNo=findViewById(R.id.editTextTRegNo);
            ...
            public void onClick(View v) {
                ...
                checkExistenceQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()){
                            Toast.makeText(AddStudentActivity.this,"User already exists.",Toast.LENGTH_SHORT).show();
                        }
                        else{
                            ...
                            checkPhoneQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                   if(snapshot.exists()){
                                       Toast.makeText(AddStudentActivity.this,"Phone number already registered.",Toast.LENGTH_SHORT).show();
                                   }
                                   else{
                                       ...
                                       if(userType.equals("student"))
                                           ...
                                           role="Faculty";
                                       AddUserClass newUser=new AddUserClass(name,regNo,phone,search,role,profileData.get(ProfileSharedPreferences.KEY_BRANCH),false);
                                       reference.child(regNo).setValue(newUser);
                                       Intent intent = new Intent(AddStudentActivity.this, AddDeleteUserActivity.class);
    ...
    private boolean isConnected(AddStudentActivity activity) {

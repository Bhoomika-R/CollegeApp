...
public class ResetPasswordActivity extends AppCompatActivity {
    ...
    private String password,role,regNo,branch;
    @Override
    ...
    public void onClickReset(View view){
        ...
        if(role.equals("Student")){
            reference=rootNode.getReference("root").child("profiles").child(branch).child("student");
        }
        else {
            reference=rootNode.getReference("root").child("profiles").child(branch).child("faculty");
        }

        reference.child(regNo).child("password").setValue(password);

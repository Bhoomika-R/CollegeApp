...
public class SignUpStep1_1Activity extends AppCompatActivity {
    ...
    public void onClickNext(View view){
        ...
        Query whetherRegistered;
        if(previousActivityIntent.getStringExtra("Role").equals("Principal"))
          whetherRegistered= FirebaseDatabase.getInstance().getReference("root").child("profiles").child(previousActivityIntent.getStringExtra("Role").toLowerCase(Locale.ROOT)).orderByChild("regNo").equalTo(regNo);
        else
          whetherRegistered= FirebaseDatabase.getInstance().getReference("root").child("profiles").child(previousActivityIntent.getStringExtra("Branch")).child(previousActivityIntent.getStringExtra("Role").toLowerCase(Locale.ROOT)).orderByChild("regNo").equalTo(regNo);

...
public class SignUpStep1Activity extends AppCompatActivity {
    private Spinner roleSpinner,branchSpinner,semSpinner;
    private TextView tv_join,tv_us,tv_select_sem,tvBranch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        roleSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if(position==0){
                  tv_select_sem.setVisibility(View.VISIBLE);
                  semSpinner.setVisibility(View.VISIBLE);
                }
                else if(position==1){
                    tv_select_sem.setVisibility(View.GONE);
    ...
    private void setupSpinner(){
        ...
        ArrayAdapter<CharSequence> adapter3 = ArrayAdapter.createFromResource(this,
                R.array.sem_spinner, android.R.layout.simple_spinner_item);
        adapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        semSpinner.setAdapter(adapter3);
    }
    ...
    public void onClickNext(View view){
        ...
        intent.putExtra("Role",roleSpinner.getSelectedItem().toString());
        intent.putExtra("Branch",branchSpinner.getSelectedItem().toString());
        intent.putExtra("Sem",semSpinner.getSelectedItem().toString());

...
public class SignUpStep4Activity extends AppCompatActivity {
    ...
    public void onClickNext(View view){
        ...
        String role=intentPreviousActivity.getStringExtra("Role");
        ...
        String sem=intentPreviousActivity.getStringExtra("Sem");
        String designation=intentPreviousActivity.getStringExtra("Designation");
        String qualifications=intentPreviousActivity.getStringExtra("Qualifications");
        ...
        Query phoneMatching= FirebaseDatabase.getInstance().getReference("root").child("profiles").child(branch).child(role.toLowerCase(Locale.ROOT)).orderByChild("regNo").equalTo(regNo);

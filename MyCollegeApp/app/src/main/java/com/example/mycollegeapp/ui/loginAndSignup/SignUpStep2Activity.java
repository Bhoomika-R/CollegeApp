...
public class SignUpStep2Activity extends AppCompatActivity {
    ...
    private TextInputLayout etEmail,etPassword,etReEnterPassword;
    ...
    public void onClickNext(View view){
        ...
        intent.putExtra("Role",previousActivityIntent.getStringExtra("Role"));
        intent.putExtra("Branch",previousActivityIntent.getStringExtra("Branch"));
        intent.putExtra("Sem",previousActivityIntent.getStringExtra("Sem"));
        ...
        Query whetherRegistered= FirebaseDatabase.getInstance().getReference("root").child("profiles").child(previousActivityIntent.getStringExtra("Branch")).child(previousActivityIntent.getStringExtra("Role").toLowerCase(Locale.ROOT)).orderByChild("regNo").equalTo(previousActivityIntent.getStringExtra("RegNo"));
        whetherRegistered.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    String designation = snapshot.child(previousActivityIntent.getStringExtra("RegNo")).child("designation").getValue(String.class);
                    String qualifications = snapshot.child(previousActivityIntent.getStringExtra("RegNo")).child("qualifications").getValue(String.class);

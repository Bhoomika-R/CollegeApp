...
public class SignUpStep3Activity extends AppCompatActivity {
    ...
    public void onClickNext(View view) {
        ...
        intent.putExtra("Designation",previousActivityIntent.getStringExtra("Designation"));
        intent.putExtra("Qualifications",previousActivityIntent.getStringExtra("Qualifications"));
